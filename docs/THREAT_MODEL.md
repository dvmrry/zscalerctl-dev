...
Review stamp: last reviewed on 2026-07-28 against
`github.com/zscaler/zscaler-sdk-go/v3 v3.8.43`. Re-review this threat model on
...
Status metadata follows a deliberately different contract. `doctor`,
