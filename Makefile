...
.PHONY: fmt-check test race vet vuln staticcheck docs-check docs-cli-check gen-cli-docs semgrep-check secret-scan vendor verify-vendor verify-licenses verify-sdk-boundary verify-ci-no-live-creds verify-actions-pinned verify-surface-changes-manifest verify-tui-import-boundary verify-pty-escape-clean verify-bubbletea-vendor-patch verify-zscalerctl-tui-live-failure verify-release-automation verify-release-artifacts verify-catalog-draft verify-resource-scaffold verify-sdk-surface-inventory verify-script-registry verify-agents-skill scaffold-resource sdk-surface-inventory field-coverage live-smoke fuzz-smoke check release-check
...
verify-tui-import-boundary:
	bash scripts/verify-tui-import-boundary.sh
	bash scripts/test-verify-tui-import-boundary.sh

verify-pty-escape-clean:
	bash scripts/verify-pty-escape-clean.sh

verify-bubbletea-vendor-patch:
	bash scripts/verify-bubbletea-vendor-patch.sh
	bash scripts/test-verify-bubbletea-vendor-patch.sh

verify-zscalerctl-tui-live-failure:
	bash scripts/verify-zscalerctl-tui-live-failure.sh
...
check: fmt-check test race vet vuln staticcheck verify-licenses docs-check docs-cli-check semgrep-check secret-scan verify-sdk-boundary verify-ci-no-live-creds verify-actions-pinned verify-surface-changes-manifest verify-tui-import-boundary verify-pty-escape-clean verify-bubbletea-vendor-patch verify-zscalerctl-tui-live-failure verify-release-automation verify-release-artifacts verify-catalog-draft verify-resource-scaffold verify-sdk-surface-inventory verify-script-registry verify-agents-skill
