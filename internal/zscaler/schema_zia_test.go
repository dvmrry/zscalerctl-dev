...
func reviewedSDKShapesZIA() []sdkShapeReview {
	return []sdkShapeReview{
		...
		{
			name: "ziacommon.EndPointApplications",
			typ:  reflect.TypeOf(ziacommon.EndPointApplications{}),
			ignoredFields: mergeIgnoredFields(
				ignoredBecause(
					"deliberate: modeled as compact policy references under endPointApplications on ZIA SSL inspection, firewall filtering, and firewall DNS rules",
					"resourceId",
					"applicationName",
					"osType",
					"applicationType",
				...
				ignoredBecause(
					"deliberate: endpoint application inventory details are not needed to identify a policy dependency and are omitted before projection",
					"description",
					"bundleID",
					"filename",
					"originalFileName",
		...
		{
			name: "ziacommon.EndPointApplicationGroups",
			typ:  reflect.TypeOf(ziacommon.EndPointApplicationGroups{}),
			ignoredFields: mergeIgnoredFields(
				ignoredBecause(
					"deliberate: modeled as compact policy references under endPointApplicationGroups on ZIA SSL inspection, firewall filtering, and firewall DNS rules",
					"groupId",
					"name",
				),
				ignoredBecause(
					"deliberate: group descriptions, modification metadata, and nested endpoint application inventories are omitted before projection",
					"description",
					"modUId",
					"lastModifiedTime",
					"endPointApplications",
