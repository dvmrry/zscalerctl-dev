			...
			Fields: []FieldSpec{
				...
				},
				{
					...
					Fields: []FieldSpec{
						...
						tenantConfigField("showEUN", standardShareModes()),
						tenantConfigField("showEUNATP", standardShareModes()),
						tenantConfigField("overrideDefaultCertificate", standardShareModes()),
						{
							Name:                "sslInterceptionCert",
							Classification:      ClassTenantConfig,
							AllowedModes:        standardShareModes(),
							SensitiveNameReason: "certificate reference metadata needed to distinguish configured SSL interception cert rollout, not certificate key material",
							Fields: []FieldSpec{
						...
						{
							Name:           "decryptSubActions",
							Classification: ClassTenantConfig,
							AllowedModes:   standardShareModes(),
							Fields: []FieldSpec{
								tenantConfigField("serverCertificates", standardShareModes()),
								tenantConfigField("ocspCheck", standardShareModes()),
								tenantConfigField("blockSslTrafficWithNoSniEnabled", standardShareModes()),
								tenantConfigField("minClientTLSVersion", standardShareModes()),
								tenantConfigField("minServerTLSVersion", standardShareModes()),
								tenantConfigField("blockUndecrypt", standardShareModes()),
								tenantConfigField("http2Enabled", standardShareModes()),
							},
						},
						{
							Name:           "doNotDecryptSubActions",
							Classification: ClassTenantConfig,
							AllowedModes:   standardShareModes(),
							Fields: []FieldSpec{
								tenantConfigField("bypassOtherPolicies", standardShareModes()),
								tenantConfigField("serverCertificates", standardShareModes()),
								tenantConfigField("ocspCheck", standardShareModes()),
								tenantConfigField("blockSslTrafficWithNoSniEnabled", standardShareModes()),
								tenantConfigField("minTLSVersion", standardShareModes()),
							},
						},
					},
				},
				...
				endpointApplicationsField("endPointApplications"),
				endpointApplicationGroupsField("endPointApplicationGroups"),
			},
		},
		{
			Product:    ProductZIA,
